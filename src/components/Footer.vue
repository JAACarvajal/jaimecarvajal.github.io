<template>
  <div
    class="flex flex-col place-content-between mx-auto w-full h-auto md:h-2/5 bg-black px-8 md:px-40 md:pt-20 py-8"
  >
    <div
      class="flex flex-col justify-between md:flex-row items-center text-white gap-10"
    >
